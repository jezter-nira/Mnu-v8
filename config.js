...
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'Manu-MD&Tdnh4i1y', // Put your session id here ( after linked check your number and get session id it need start with Manu-MD& ) 🤍
